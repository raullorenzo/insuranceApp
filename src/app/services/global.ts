export const GLOBAL = {
  url: 'assets/data/insurProducts.json',
  data: [
    {
      id: '1',
      name: 'Casa mia!',
      brand: 'Generali',
      brandImage: 'brand_generali.png',
      kind: 'Hogar',
      KindImage: 'kind_home.png',
      price: '300'
    },
    {
      id: '2',
      ...
      brand: 'Mapfre',
      brandImage: 'brand_mapfre.png',
      kind: 'Vida',
      KindImage: 'kind_life.png',
      price: '100'
    },
    {
      id: '3',
      name: 'Panacea',
      brand: 'Zurich',
      brandImage: 'brand_zurich.png',
      kind: 'Viaje',
      KindImage: 'kind_travel.png',
      price: '50'
    },
    {
      id: '4',
      name: '<mis_datos>',
      brand: 'AXA',
      brandImage: 'brand_axa.png',
      kind: 'Cybersecurity',
      KindImage: 'kind_cybersecurity.png',
      price: '1010'
    },
    {
      id: '5',
      ...
      brand: 'Liberty',
      brandImage: 'brand_liberty.png',
      kind: 'Coche',
      KindImage: 'kind_car.png',
      price: '120'
    },
    {
      id: '6',
